...
export const useFirstAidData = () => {
  ...
  return [
    ...
    { id: 5, title: t("FirstAidHomeData.BITES_STINGS_BEES_WASPS_HORNETS_ANTS"), src: require("../assets/firstAid/bee_stings.webp"), screen: "Bees" },
    { id: 6, title: t("FirstAidHomeData.BITES_STINGS_RED_BACK_OTHER_SPIDERS"), src: require("../assets/firstAid/spider_bites.webp"), screen: "Redback" },
    { id: 7, title: t("FirstAidHomeData.BITES_STINGS_SNAKE_FUNNEL_WEB"), src: require("../assets/firstAid/snake_bite.webp"), screen: "Funnelspider" },
