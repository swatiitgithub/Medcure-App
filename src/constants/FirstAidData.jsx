...
export const useFirstAidData = () => {
  ...
  return [
    ...
    { id: 9, title: t("FirstAidHomeData.BROKEN_BONE_FRACTURE"), screen :"BrokenBoneFacture" },
    ...
    { id: 23, title: t("FirstAidHomeData.NOSE_BLEED"), screen:"NoseBleed" },
    ...
    { id: 28, title: t("FirstAidHomeData.STRAINS_SPRAINS_BRUISES"), screen:"StrainsSprainsAndBruises" },
    { id: 29, title: t("FirstAidHomeData.STROKE"),screen:"Stroke" },
    { id: 30, title: t("FirstAidHomeData.VITAL_SIGNS"), screen:"VitalSign" }
  ];
};
