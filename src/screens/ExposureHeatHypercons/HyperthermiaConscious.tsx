  ...
  return (
    <ScrollView
      ...
      <View
        ...
        {[
          t('ExposuretoHeat.Hyperthermiacons.sym1'),
          t('ExposuretoHeat.Hyperthermiacons.sym2'),
          t('ExposuretoHeat.Hyperthermiacons.sym3'),
          t('ExposuretoHeat.Hyperthermiacons.sym4'),
        ].map((step, index) => (
          <View
            key={index}
            style={[
...
export default HyperthermiaConscious;
