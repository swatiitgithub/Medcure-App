  ...
  return (
    <ScrollView
      ...
      <Title
        ...
        {t('ExposuretoHeat.HeatStrokeConcious.title')}
      </Title>
      <Title
      ...
      <Title
        style={[styles.typesHeader, {color: isDarkMode ? '#fff' : '#000'}]}>
        {t('ExposuretoHeat.HeatStrokeConcious.Subtitle')}
      </Title>

      <View
        style={[styles.card, isDarkMode ? styles.darkCard : styles.lightCard]}>
        {[
          t('ExposuretoHeat.HeatStrokeConcious.step1'),
          t('ExposuretoHeat.HeatStrokeConcious.step2'),
          t('ExposuretoHeat.HeatStrokeConcious.step3'),
          t('ExposuretoHeat.HeatStrokeConcious.step4'),
        ].map((step, index) => (
          <View
            key={index}
            style={[
