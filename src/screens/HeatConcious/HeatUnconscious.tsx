  ...
  return (
    <ScrollView
      ...
      <Title
        ...
        {t('ExposuretoHeat.HeatStrokeUnConcious.title')}
      </Title>
      <Title
      ...
      <Title
        style={[styles.typesHeader, {color: isDarkMode ? '#fff' : '#000'}]}>
        {t('ExposuretoHeat.HeatStrokeUnConcious.subtitle')}
      </Title>

      <View
        style={[styles.card, isDarkMode ? styles.darkCard : styles.lightCard]}>
        {[
          t('ExposuretoHeat.HeatStrokeUnConcious.sym1'),
          t('ExposuretoHeat.HeatStrokeUnConcious.sym2'),
          t('ExposuretoHeat.HeatStrokeUnConcious.sym3'),
          t('ExposuretoHeat.HeatStrokeUnConcious.sym4'),
          t('ExposuretoHeat.HeatStrokeUnConcious.sym5'),
        ].map((step, index) => (
          <View
            key={index}
            style={[
      ...
      <TouchableOpacity
        ...
        <Text style={styles.buttonText}>{t('ExposuretoHeat.button.next')}</Text>
      </TouchableOpacity>
      <Button
        mode="contained"
...
export default HeatUnconscious;
