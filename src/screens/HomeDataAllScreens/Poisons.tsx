    ...
    <ScrollView
      ...
      <View
        ...
        <Button
          ...
          style={styles.callButton}
          onPress={() =>
            navigation.navigate('PoisonsCons', {condition: 'asthma'})
          }>
          {t('Poisons.button.name1')}
        </Button>
        <Button
          mode="contained"
          style={styles.callButtonname2}
          onPress={() =>
            navigation.navigate('PoisonsUncons', {condition: 'asthma'})
          }>
          {t('Poisons.button.name2')}
        </Button>
      </View>
    </ScrollView>
  );
