  ...
  return (
    <ScrollView
      ...
      <View
        ...
        {[t('Attack.symptoms.sym1'),
         t('Attack.symptoms.sym2'),
         t('Attack.symptoms.sym3'),
         t('Attack.symptoms.sym4'),
         t('Attack.symptoms.sym5'),
         t('Attack.symptoms.sym6'),
        ].map(
          (item, index) => (
      ...
      <View
        ...
        <Button
          ...
          onPress={() =>
            navigation.navigate('Attackconcious', {condition: 'asthma'})
          }>
