  ...
  return (
    <ScrollView
      ...
      <View
        ...
        <View>
          <Paragraph
            ...
            {t('HeadInjury.History.description')}
          </Paragraph>
        </View>
      </View>
      ...
      <View
        ...
        {[t('HeadInjury.symptoms.sym1'), t('HeadInjury.symptoms.sym2')].map(
          (item, index) => (
      ...
      <Button
        ...
        onPress={() =>
          navigation.navigate('Conscious', { condition: 'HeadInjury' })
        }>
        {t('HeadInjury.button.name1', 'Conscious')}
      </Button>
      <Button
        mode="contained"
        style={styles.callButtonname2}
        onPress={() =>
          navigation.navigate('Unconscious', { condition: 'HeadInjury' })
        }>
        {t('HeadInjury.button.name2', 'Unconscious')}
      </Button>
    </View>
    </ScrollView>
  );
