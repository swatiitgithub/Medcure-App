  ...
  return (
    <ScrollView
      ...
      <Title style={[isDarkMode ? styles.darkText : styles.lightText]}>
        {t('Choking.EffectiveCoughing.Subtitle')}
      </Title>
      ...
      <View
        ...
        {[
          t('Choking.EffectiveCoughing.step1'),
       ...
       <Image source={require('../../assets/Images/Coughing.png')} style={styles.image} />
       <Title
        style={[styles.typesHeader, {color: isDarkMode ? '#fff' : '#000'}]}>
        {t('Choking.EffectiveCoughing.des1')}
      </Title>
      ...
      <View
        ...
        {[
          t('Choking.EffectiveCoughing.step2'),
