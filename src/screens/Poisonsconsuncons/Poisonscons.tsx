  ...
  return (
    <ScrollView
      ...
      <View style={[styles.card, isDarkMode ? styles.darkCard : styles.lightCard]}>
        {[
          t('Poisons.management.conscious.cons1'),
          t('Poisons.management.conscious.cons2'),
          t('Poisons.management.conscious.cons3'),
          t('Poisons.management.conscious.cons4'),
          t('Poisons.management.conscious.cons5'),
        ].map((step, index) => (
          <View
            key={index}
            style={[
